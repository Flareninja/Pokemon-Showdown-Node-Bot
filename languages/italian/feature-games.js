exports.translations = {
	commands: {
		...
		rps: {
			'err': 'Scegli roccia, carta o forbici',
			'r': 'Roccia',
			'p': 'Carta',
			's': 'Forbici',
			'win': 'Hai vinto!',
	...
	games: {
		hangman: {
			...
			'lose1': '**Game over!** è stato superato il numero massimo di errori',
			'lose2': 'fu impiccato! La parola era',
			'end': 'Il gioco dell\'Hangman è stato terminato. La parola era'
		},
		anagrams: {
			'and': 'e',
			...
			'lose': '**Il gioco dell\'Anagram è finito!** Ma nessuno ha ottenuto i punti quindi non ci sono vincitori',
			'end': 'Il gioco dell\'Anagram è finito!',
			'grats1': 'Congratulazioni a',
			'grats2': 'per aver vinto la partita con',
			'points': 'punti',
			'tie1': 'Il risultato è un pareggio',
			'tie2': 'fra',
			'forceend1': 'Il gioco dell\'Anagram è stata terminato!',
			'forceend2': 'La parola era'
		},
		pokehangman: {
			'help': 'Usa __$TOKENg [parola/carattere]__ per giocare',
			'grats1': 'Congratulazioni a',
			'grats2': 'per aver vinto il gioco Poke-Hangman! La parola era',
			'lose1': '**Game over!** è stato superato il numero massimo di errori',
			'lose2': 'fu impiccato! La parola era',
			'end': 'Il gioco del Poke-Hangman è stata terminato. La parola era'
		},
		pokeanagrams: {
			'and': 'e',
			'start': 'Un nuovo **Poke-Anagram** è stato creato!',
			'maxgames1': 'Sarà un max di',
			'maxgames2': 'giochi',
			'maxpoints1': 'Se qualcuno ottiene',
			'maxpoints2': 'punti, lui / lei vince',
			...
			'point3': 'Risultati provvisori',
			'timeout': '**Il tempo è scaduto!** La parola era',
			'lose': '**Il gioco del Poke-Anagram è finito!** Ma nessuno ha ottenuto i punti quindi non ci sono vincitori',
			'end': 'Il gioco del Poke-Anagram è finito!',
			'grats1': 'Congratulazioni a',
			'grats2': 'per aver vintp la partita con',
			'points': 'punti',
			'tie1': 'Il risultato è un pareggio',
			'tie2': 'fra',
			'forceend1': 'Il gioco del Poke-Anagrams è stata terminato!',
			'forceend2': 'La parola era'
		},
		trivia: {
			'and': 'e',
			...
			'correct': 'Corretto',
			'point1': 'ha risposto correttamente alla domanda',
			'point2': 'Risultati provvisori',
			'timeout': '**Il tempo è scaduto!**',
			'timeout2': 'La risposta è stata',
			'timeout3': 'Le risposte valide erano',
			'lose': '**Il gioco del Trivia è finito!** Ma nessuno ha ottenuto i punti quindi non ci sono vincitori',
			'end': 'Il gioco del Trivia è finito!',
			'grats1': 'Congratulazioni a',
		...
		blackjack: {
			...
			'turn1': 'è Il turno di',
			'turn2': '!',
			'helpturn1': 'Utilizzare **$hit** per ottenere nuove carte e **$stand** per terminare il turno (si dispone di un massimo di',
			'helpturn2': 'secondi)',
			'hand1': 'La mano di',
			'hand2': '',
			'stand': 'stands',
			...
			'grats1': 'Congratulazioni a',
			'grats2': 'per aver vinto la partita',
